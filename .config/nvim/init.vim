...
set showmode
set ruler
set inccommand=                                         " don't preview replace changes
...
command! CopyDir silent let @" = expand("%:h") | let @+ = @"
command! CopyFullPath silent let @" = expand('%:p') | let @+ = @"
...
" this should be the default tbh
